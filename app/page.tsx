        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <Image src={'/logo.svg'} alt="logo" width={150} height={150} className="w-full " />
              {/* </button> */}
            </div>
          </div>
          <div
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7">
              {!user?.user?.email ? (
                <Authentication>
                  <div className="flex items-center gap-x-2 font-medium text-gray-500 cursor-pointer hover:text-blue-600 sm:border-s sm:border-gray-300 py-2 sm:py-0 sm:ms-4 sm:my-6 sm:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500">
                    <svg
